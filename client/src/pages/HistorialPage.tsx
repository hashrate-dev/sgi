...
/** Normaliza mes a YYYY-MM (ej. "2026-1" -> "2026-01") para filtrar por columna MES */
...
export function HistorialPage({ sourceFilter }: HistorialPageProps) {
  ...
  const stats = useMemo(() => {
    const src = filtered as InvoiceWithSource[];
  ...
  const pageTitle = sourceFilter === "hosting" ? "Historial Servicios de Hosting" : sourceFilter === "asic" ? "Historial Venta de ASIC" : "Detalles de Documentos Emitidos";
  const pageSubtitle = sourceFilter === "hosting"
    ? "Documentos detalle por Servicios de Hosting. Filtros por cliente, tipo y mes."
    : sourceFilter === "asic"
      ? "Documentos detalle por Ventas de Equipos ASIC. Filtros por cliente, tipo y mes."
      : "Documentos emitidos. Filtros por cliente, tipo y mes.";

  return (
    <div className="fact-page clientes-page">
      <div className="container">
        <PageHeader title={pageTitle} showBackButton backTo="/" backText="Volver al inicio" />
