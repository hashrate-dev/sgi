...
export const SGI_PERMISSION_SCREEN_MAP: readonly SgiPermissionScreenRow[] = [
  ...
  {
    id: "ga-garantias-ande-clientes",
    zoneOrder: 10,
    zone: "Gestión Administrativa",
    legacyModule: "garantias",
    title: "Garantías ANDE (Clientes)",
    routes: ["/gestion-administrativa/garantias-ande-clientes"],
    accessNote: "Registro de garantías ANDE en USD vinculadas a clientes de hosting y equipos ASIC.",
    audience: ["staff", "lector"],
  },
  {
  ...
  },
  {
    ...
    title: "Noticias cripto — sala de redacción",
    routes: ["/gestion-administrativa/noticias"],
    accessNote: "Wire e historial de noticias cripto capturadas por el bot (BTC, alts, USA, Uruguay).",
    audience: ["staff", "lector"],
  },
  {
    id: "ga-comunicacion",
    ...
    routes: ["/gestion-administrativa/comunicacion", "/gestion-administrativa/comunicacion/usuarios-bot", "/gestion-administrativa/comunicacion/cortes"],
